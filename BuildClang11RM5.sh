...
# Paths
KERNEL_DIR=`pwd`
ZIMAGE_DIR="~/RM5G_R/out-clang/arch/arm64/boot/"

# Kernel Details
VER="-BETA"

# Vars
BASE_AK_VER="MOD-RM5G_R-STOCK"
...
# Make a dtb file
#find ~/RM5G_R/out-clang/arch/arm64/boot/dts/vendor/qcom -name '*.dtb' -exec cat {} + > ~/RM5G_R/out-clang/arch/arm64/boot/dtb
cd ~/RM5G_R/out-clang/arch/arm64/boot/
